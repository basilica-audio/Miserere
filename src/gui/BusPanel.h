...
// One faceplate panel per bus/section of the M3 vector editor (issue #25):
// paints its own opaque near-black panel with an engraved serif header and
// a thin gold rule, and - the a11y half (issue #26, WCAG 4.1.2 grouping) -
// acts as an ACCESSIBILITY focus container with its own title, so a screen
// reader announces "Crush bus, Ratio" instead of one flat ~70-control list.
//
