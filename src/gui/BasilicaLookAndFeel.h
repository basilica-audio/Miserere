...
// Suite-wide Basilica look & feel - Miserere's M3 VECTOR variant (issue #25).
//
...
// Miserere's M3 editor is drawn at runtime with juce::Graphics/juce::Path:
// pointer knobs with engraved scale rings, lamp toggles, per-bus needle
